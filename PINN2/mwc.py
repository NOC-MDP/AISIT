...
for model_year in model_years:
    for i in range(12):
        ...
        def d18O_seaice_endmember(depth, z_transition=50, width=15,
                                   d18O_shallow=2.0, d18O_deep=0.3):
            """
        ...
        def d18O_meteoric_endmember(depth, z_transition=200, width=50,
                                     d18O_shallow=-20.0, d18O_deep=-5.0):
            """
...
df.to_parquet(f'infer_output/MWC/mwc_siwc_{start_year}_{end_year}_{lat_n}_{lat_s}_{lon_e}_{lon_w}.parquet')
